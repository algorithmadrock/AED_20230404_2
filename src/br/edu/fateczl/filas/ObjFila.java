/*
 RESUMO		 : 3. Biblioteca de Object, Classe fila
...
public class ObjFila {

	private ObjNo inicio, fim;
...
//				adiciono ele ao fim da fila normalmente
	...
	public Object remove() throws Exception {
		if (vazia()) {
			...
			Object valor = inicio.dado; //dado que vai sair da fila
